...
\begin{table}[H]
    \centering
        ...
        client/menus/Main.cs & Calculating a summary of a user's statistics & page \\\hline
...
% ~ do i specifically have enough diagrams
% ~ have i sufficiently explained the neural network
% ~ do i need a test for every objective
% ~ do i need a whole system test
% ~ what if uml diagrams are a little inaccurate
% ~ is my testing video too fast
