...
\href{https://1drv.ms/f/c/3e1f08d3e4fd818b/IgCUS8aHwVSwRLBoNFkl4_LRAT6VirQSBWDmTAvQZIteqOY?e=ovwiRN}{Link to the Testing Video}
...
\begin{enumerate}
    ...
    \begin{enumerate}
		\item \textbf{05:52} The multiplication operation is correctly applied to two matrices.
        ...
        \item \textbf{06:14} The network shows significant statistical evidence of correctly selecting the drawn letter.
    \end{enumerate}
...
% something about the client being easy to use and handles exceptions well
